...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { account_name: @bank.account_name, account_number: @bank.account_number, name: @bank.name, user_id: @bank.user_id } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { account_name: @bank.account_name, account_number: @bank.account_number, name: @bank.name, user_id: @bank.user_id } }
